...
public class BaseRequest extends Request<NetworkResponse> {
	 ...
	 *            Error listener, or null to ignore errors
	 */
	public BaseRequest(String url, Listener<NetworkResponse> listener,
	...
	public String getUrl() {
		...
		if (getMethod() == Method.GET && params != null && params.size() > 0) {
			return TuServerConfig.API_SERVER_URL
					+ TuHttpUtils.genrateUrlparams(TuServerConfig.API_SERVER_URL, params,
							getParamsEncoding());
		}
